...
configiso.read("00_configiso.ini", encoding="ISO-8859-1")
...
#config.read("00_configiso.ini", encoding="ISO-8859-1")
...
#config.read("00_config.ini", encoding="ISO-8859-1")
